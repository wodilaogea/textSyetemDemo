...
<script type="text/babel">
  import { getRangeHours, getRangeMinutes, modifyTime } from 'webApp/element-ui/src/utils/date-util';
  import ElScrollbar from 'webApp/element-ui/packages/scrollbar';
  import RepeatClick from 'webApp/element-ui/src/directives/repeat-click';
