<script>
  ...
  import ElButton from 'webApp/element-ui/packages/button';
  import ElButtonGroup from 'webApp/element-ui/packages/button-group';
  import { generateId } from 'webApp/element-ui/src/utils/util';
